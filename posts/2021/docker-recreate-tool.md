---
title: Docker recreate tool
date: 2021-07-11
slug: docker-recreate-tool
---

现在 docker 使用的越来越多，有很多部署工具可以使用，但有些时候需要临时手动重建容器。我写了一个 Python 小脚本来实现类似的功能。

* Github repo: https://github.com/jeffrey4l/docker-recreate
